...
| `references/checklists.md` | 提出前の12テストと、長すぎる原稿の直し順 | 提出前 |
...
ユーザーの確認は不要。提出前に `references/checklists.md` の12テストを走らせ、**数えられる指標は実際に数える**。
...
4. 完了メッセージはレポートとは別物。見出し一覧・文字数・答えの一文と、`checklists.md` の数えられる指標の実測値を示す。本文をチャットに貼らない
