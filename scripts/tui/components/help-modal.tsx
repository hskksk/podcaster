  ...
  return (
    ...
    >
      ...
      <Box marginTop={1} flexDirection="column">
        ...
        <Text dimColor>Episodes (detail): p play / s stop / Ctrl+S script / Ctrl+A audio / Ctrl+Y rss / Ctrl+G regen-script / Ctrl+R regen-audio / Ctrl+I regen-image / Ctrl+D download</Text>
